...
Begin VB.Form frmRL2B1 
   Caption         =   "Morbiditas"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8325
   Icon            =   "frmRL2B1.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6795
   ScaleWidth      =   8325
   ...
   End
End
Attribute VB_Name = "frmRL2B1"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New crRL2B1
...
Private Sub Form_Load()
    ...
    With Report
        ...
        .txtJudul2.SetText "FORMULIR RL2b1"
        ...
        .unKelL.SetUnboundFieldSource ("{ado.JmlPasienOutWanita}")
        .unKelP.SetUnboundFieldSource ("{ado.JmlPasienOutPria}")
