...
Begin VB.Form frmsmta 
   Caption         =   "Medifirst2000 - Data Ketenagaan"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8325
   Icon            =   "frmsmta.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6795
   ScaleWidth      =   8325
   ...
   End
End
Attribute VB_Name = "frmsmta"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New crsmta
...
Private Sub Form_Load()
    ...
    "jmlhonorer " & _
    "FROM V_Ketenagaan WHERE  (KdkualifikasiJurusan IN ('0013', '0047','0048','0051','0052')) " & _
    ...
    With Report
        ...
        .Text3.SetText "5. SEKOLAH MENENGAH TINGKAT ATAS"
