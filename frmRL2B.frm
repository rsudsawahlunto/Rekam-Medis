...
Begin VB.Form frmRL2B 
   Caption         =   "Morbiditas"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8325
   Icon            =   "frmRL2B.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6795
   ScaleWidth      =   8325
   ...
   End
End
Attribute VB_Name = "frmRL2B"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New crRL2B
...
Private Sub Form_Load()
    ...
    'Triwulan 1
    If frmLapRL2B.Check1.value = vbChecked And frmLapRL2B.Option1.value = True Then
        With Report
            .Database.AddADOCommand dbConn, adoCommand

            .txtJudul.SetText "DATA KEADAAN MORBIDITAS PASIEN RAWAT JALAN RUMAH SAKIT"
            .Text1.SetText strNNamaRS
            .txtJudul2.SetText "FORMULIR RL2b"
            .Text3.SetText " I "
            ...
            .unKelM.SetUnboundFieldSource ("{ado.Total}")
        End With
        strSQL = "select * " & _
        " from V_Koders  "
    ...
    'Triwulan 2
    If frmLapRL2B.Check1.value = vbChecked And frmLapRL2B.Option2.value = True Then
        With Report
            .Database.AddADOCommand dbConn, adoCommand
    ...
    'Triwulan 3
    If frmLapRL2B.Check1.value = vbChecked And frmLapRL2B.Option3.value = True Then
        With Report
            .Database.AddADOCommand dbConn, adoCommand
    ...
    'Triwulan 4
    If frmLapRL2B.Check1.value = vbChecked And frmLapRL2B.Option4.value = True Then
        With Report
            .Database.AddADOCommand dbConn, adoCommand
    ...
    'Periode
    If frmLapRL2B.Check1.value = vbUnchecked Then
        With Report
            .Database.AddADOCommand dbConn, adoCommand
