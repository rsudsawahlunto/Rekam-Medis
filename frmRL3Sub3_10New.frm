...
Begin VB.Form frmRL3Sub3_10New 
   ...
   ClientTop       =   375
   ClientWidth     =   6135
   Icon            =   "frmRL3Sub3_10New.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRL3Sub3_10New.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   4575
   End
   ...
   End
End
Attribute VB_Name = "frmRL3Sub3_10New"
...
Private Sub cmdCetak_Click()
    ...
    strSQL = "Select distinct * from RL3_10New where TglPelayanan between '" & Format(dtpAwal.value, "yyyy/MM/dd 00:00:00") & "' and '" & Format(dtpAkhir.value, "yyyy/MM/dd 23:59:59") & "'"
    ...
    If rs.RecordCount > 0 Then
        ...
        While Not rs.EOF
            ...
            If rs!JenisKegiatan = "Electro Encephalografi (EEG)" Then
                j = 13
            ElseIf rs!JenisKegiatan = "Electro Kardiographi (EKG)" Then
                j = 14
            ElseIf rs!JenisKegiatan = "Endoskopi (semua bentuk)" Then
                j = 17
            ElseIf rs!JenisKegiatan = "Hemodialisa" Then
                j = 18
            ElseIf rs!JenisKegiatan = "Densitometri Tulang" Then
                j = 19
            ElseIf rs!JenisKegiatan = "Pungsi" Then
                j = 21
            ElseIf rs!JenisKegiatan = "Spirometri" Then
                j = 22
            ElseIf rs!JenisKegiatan = "Test Kulit/Alergi/Histamin" Then
                j = 23
            ElseIf rs!JenisKegiatan = "Topometri" Then
                j = 24
            ElseIf rs!JenisKegiatan = "Treadmill/Exercise Test" Then
                j = 25
