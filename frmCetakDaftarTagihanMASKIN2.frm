...
Begin VB.Form frmCetakDaftarTagihanMASKIN2 
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   Icon            =   "frmCetakDaftarTagihanMASKIN2.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   4680
   ...
   End
End
Attribute VB_Name = "frmCetakDaftarTagihanMASKIN2"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'by splakuk fix 26-11-2008
Dim Report As New crCetakDaftarTagihanMASKIN2
