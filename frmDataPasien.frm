...
Begin VB.Form frmDataPasien 
   ...
   Begin VB.Frame fraPasien 
      ...
      Begin VB.ComboBox cboNamaDepan 
         ...
         EndProperty
         Height          =   390
         ItemData        =   "frmDataPasien.frx":0CCA
         Left            =   240
         List            =   "frmDataPasien.frx":0CE3
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   600
         Width           =   1335
      ...
      Begin VB.ComboBox cboJnsKelaminPasien 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmDataPasien.frx":0D0E
         Left            =   240
         List            =   "frmDataPasien.frx":0D18
         Style           =   2  'Dropdown List
         TabIndex        =   10
         Top             =   1320
         Width           =   1335
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboPegawaiToPasien 
         Appearance      =   0  'Flat
         Height          =   330
         ItemData        =   "frmDataPasien.frx":0D32
         Left            =   5640
         List            =   "frmDataPasien.frx":0D34
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   480
         Visible         =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   6960
      Picture         =   "frmDataPasien.frx":0D36
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmDataPasien.frx":1ABE
      Stretch         =   -1  'True
      Top             =   0
      Width           =   13095
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmDataPasien.frx":311C
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
End
Attribute VB_Name = "frmDataPasien"
...
Private Sub cmdDetailPasien_Click()
    ...
    With frmDetailPasien
        ...
        strSQL = "Select * from KeluargaPasien where NoCM = '" & mstrNoCM & "'"
        Call msubRecFO(rs, strSQL)
...
Public Sub subLoadDataPasien(strInput As String)
 ...
 '   If Not IsNull(rsLoadPasien.Fields("Kota").value) Then dcKota.Text = rsLoadPasien.Fields("Kota").value
    ...
    Call msubRecFO(rs, strSQL)
    If rs.EOF = False Then
        If Not IsNull(rs.Fields("NamaIbu").value) Then txtNamaIbuKandung.Text = rs.Fields("NamaIbu").value
        If Not IsNull(rs.Fields("NamaKepalaKeluarga").value) Then txtNamaKepalaKeluarga.Text = rs.Fields("NamaKepalaKeluarga").value
