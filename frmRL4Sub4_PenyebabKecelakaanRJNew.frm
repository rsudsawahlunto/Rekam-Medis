...
Begin VB.Form frmRL4Sub4_PenyebabKecelakaanRJNew 
   ...
   ClientTop       =   375
   ClientWidth     =   6165
   Icon            =   "frmRL4Sub4_PenyebabKecelakaanRJNew.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRL4Sub4_PenyebabKecelakaanRJNew.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   4335
   End
End
Attribute VB_Name = "frmRL4Sub4_PenyebabKecelakaanRJNew"
...
Private Sub cmdCetak_Click()
    ...
    'Buat Buka Template
    Set oWB = oXL.Workbooks.Open(App.Path & "\Formulir RL 4B_PenyebabKecelakaan.xlsx")
