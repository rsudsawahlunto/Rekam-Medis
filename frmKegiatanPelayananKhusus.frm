...
Begin VB.Form frmKegiatanPelayananKhusus 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst 2000 - Kegiatan Pelayanan Khusus"
   ClientHeight    =   2895
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8715
   ...
   EndProperty
   Icon            =   "frmKegiatanPelayananKhusus.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   6840
      Picture         =   "frmKegiatanPelayananKhusus.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmKegiatanPelayananKhusus.frx":21B8
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmKegiatanPelayananKhusus.frx":4B79
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmKegiatanPelayananKhusus"
...
strSQL = "select distinct KdPelayananRS, NamaPelayanan, Jumlah from VlapRadiodiagnostik " & _
         ...
         "group by KdPelayananRS, NamaPelayanan, Jumlah order by NamaPelayanan"

 
 Call msubRecFO(dbRst, strSQL)
 frmCetakPelayananKhusus.Show
Exit Sub
errLoad:
    msubPesanError
End Sub
