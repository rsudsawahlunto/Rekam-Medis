...
Begin VB.Form frmRL2New 
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRL2New.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   4575
   End
End
Attribute VB_Name = "frmRL2New"
...
On Error GoTo error
    ...
    For i = 1 To 2
        ...
        For k = 1 To 40
            ...
            strSQL = "SELECT sum (Jml) as jmlpasien From RL2New " & _
...
Call KebutuhandanKekuranganPegawai
   ...
   ' strSQL = "SELECT * From ProfilRS WHERE KdRS='01'"
    ...
    With oSheet
            ...
            .Cells(9, 3) = Right(DTPickerAwal.value, 4)
    End With
...
Sub tenaga_keperawatan()
    ...
    For i = 1 To 2
        ...
        For k = 1 To 12
            ...
            strSQL = "SELECT sum (Jml) as jmlpasien From RL4New " & _
                     " WHERE JenisKelamin = '" & w & "' and KdKualifikasiJurusan = '" & X & "' "
            Set rsb = Nothing
            rsb.Open strSQL, dbConn, adOpenForwardOnly, adLockReadOnly
            With oSheet
           ...
           ElseIf k = 152 Then
            ...
            With oSheet
                If rsb.RecordCount <> 0 Then
                    .Cells(l, 8) = rsb("KebutuhanPegawaiPria").value
                    .Cells(l, 9) = rsb("KebutuhanPegawaiWanita").value
                    .Cells(l, 10) = rsb("KekuranganPegawaiPria").value
                    .Cells(l, 11) = rsb("KekuranganPegawaiWanita").value
                Else
                    .Cells(l, 8) = "0"
                    .Cells(l, 9) = "0"
                    .Cells(l, 10) = "0"
