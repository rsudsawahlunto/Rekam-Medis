...
Begin VB.Form frmTenagaKeteknisanMedis 
   Caption         =   "Medifirst2000 - Data Ketenagaan"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8325
   Icon            =   "frmTenagaKeteknisanMedis.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6795
   ScaleWidth      =   8325
   ...
   End
End
Attribute VB_Name = "frmTenagaKeteknisanMedis"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New crtenagaketeknisianmedis
...
Private Sub Form_Load()
    ...
    "jmlhonorer " & _
    "FROM V_Ketenagaan WHERE  (KdkualifikasiJurusan IN ('0095', '0096','0098','0100','102','103','0105','0107','0109','0110','0112','0113','0114','0116','0183','0184','0110','0185')) " & _
    ...
    Set frmTenagaKeteknisanMedis = Nothing
    ...
    With Report
        ...
        .Text3.SetText "7. TENAGA KETEKNISIAN MEDIS"
