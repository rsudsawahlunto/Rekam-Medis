...
Begin VB.Form frmCetakDaftarTagihanMASKIN3a 
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   Icon            =   "frmCetakDaftarTagihanMASKIN3a.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   4680
   ...
   End
End
Attribute VB_Name = "frmCetakDaftarTagihanMASKIN3a"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'by splakuk fix 26-11-2008
Dim Report As New crCetakDaftarTagihanMASKIN3a
...
Me.WindowState = 2
    ...
    With Report
       ...
       ' .udtTglPeriksa.SetUnboundFieldSource "{ado.TglPeriksa}"
        ...
        'subsettingreport Report, sPrinter, sDriver, crPaperLegal, sDuplex, crLandscape
    End With
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmCetakDaftarTagihanMASKIN3a = Nothing
End Sub
