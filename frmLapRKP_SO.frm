...
Begin VB.Form frmLapRKP_SO 
   ...
   Begin VB.Image Image1 
      Height          =   930
      Left            =   -2835
      Picture         =   "frmLapRKP_SO.frx":08CA
      Top             =   0
      Width           =   10200
   End
End
Attribute VB_Name = "frmLapRKP_SO"
...
'**********************************************
    If optGroupBy(0).Value = True Then
    '**Jika Perhari >>
        If strCetak = "LapRekapKPSO" Then
        strSQL = "SELECT * FROM  V_RekapitulasiKunjunganPasienBJenisOperasidanStatus " _
        ...
        mstrCetak2 = "LapRekapKPSOhr"
        End If
    '**Jika B Bulan >>
    ElseIf optGroupBy(1).Value = True Then
         If strCetak = "LapRekapKPSO" Then
        strSQL = "SELECT {fn MONTHNAME (TglPendaftaran) } AS TglPendaftaran, RuanganPelayanan, Judul, Detail, JK, JmlPasien, KdInstalasi  FROM  V_RekapitulasiKunjunganPasienBJenisOperasidanStatus " _
        & "WHERE (TglPendaftaran BETWEEN '" _
        & Format(mdTglAwal, "yyyy/MM/dd 00:00:00") & "' AND '" _
        & Format(mdTglAkhir, "yyyy/MM/dd 23:59:59") & "') and KdInstalasi='" & dcInstalasi.BoundText & "' "
        mstrCetak2 = "LapRekapKPSObln"
        End If
    End If
'+++++++++++++++++++++++++++++++++++++++++++++++
    msubRecFO rs, strSQL
