...
Begin VB.Form frmCetakDaftarTagihanMASKIN 
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   Icon            =   "frmCetakDaftarTagihanMASKIN.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   4680
   ...
   End
End
Attribute VB_Name = "frmCetakDaftarTagihanMASKIN"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'by splakuk fix 26-11-2008
Dim Report As New crCetakDaftarTagihanMASKIN
...
Me.WindowState = 2
    ...
    With Report
        ...
        .txtTgl.SetText ("Periode: " & Format(FrmDaftarTagihanMaskin.DTPickerAwal, "dd MMMM yyyy") & "  s/d  " & Format(FrmDaftarTagihanMaskin.DTPickerAkhir, "dd MMMM yyyy"))
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmCetakDaftarTagihanMASKIN = Nothing
End Sub
