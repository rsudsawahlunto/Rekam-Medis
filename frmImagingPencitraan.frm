...
Begin VB.Form frmImagingPencitraan 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst 2000 - IMAGING/ PENCITRAAN"
   ClientHeight    =   2670
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8715
   ...
   EndProperty
   Icon            =   "frmImagingPencitraan.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   6840
      Picture         =   "frmImagingPencitraan.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmImagingPencitraan.frx":21B8
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmImagingPencitraan.frx":4B79
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmImagingPencitraan"
...
'strSQL = "select * from VKunjRawatJalan"
...
strSQL = "select distinct KdPelayananRS, NamaPelayanan, Jumlah from VlapRadiodiagnostik " & _
        "Where Tanggal Between '" & DTPickerAwal.Day & " ' and '" & DTPickerAkhir.Day & "' " & _
         ...
         "and kdPelayananRS in ('114002', '114003', '114004', '114016', '122010', '203013', '203014') group by KdPelayananRS, NamaPelayanan, Jumlah order by NamaPelayanan"

         'TanggalS Between '" & DTPickerAwal.Day & " ' and '" & DTPickerAkhir.Day & "' " & _
         " and BulanS Between '" & DTPickerAwal.Month & "' and '" & DTPickerAkhir.Month & "'" & _
         "and TahunS Between '" & DTPickerAwal.Year & "' and '" & DTPickerAkhir.Year & "'"
 
 Call msubRecFO(dbRst, strSQL)
    frmCetaKImagingPencitraan.Show
Exit Sub
errLoad:
    msubPesanError
End Sub
