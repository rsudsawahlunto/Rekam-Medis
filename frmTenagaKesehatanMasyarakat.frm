...
Begin VB.Form frmTenagaKesehatanMasyarakat 
   Caption         =   "Medifirst2000 - Data Ketenagaan"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8325
   Icon            =   "frmTenagaKesehatanMasyarakat.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6795
   ScaleWidth      =   8325
   ...
   End
End
Attribute VB_Name = "frmTenagaKesehatanMasyarakat"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New crtenagakesehatanmasyarakat
...
Private Sub Form_Load()
    ...
    "jmlhonorer " & _
    "FROM V_Ketenagaan WHERE  (KdkualifikasiJurusan IN ('0016', '0017','0018','0019','0020','0021','0022','0023','0180')) " & _
    ...
    Set frmTenagaKesehatanMasyarakat = Nothing
    ...
    With Report
        ...
        .Text3.SetText "4. TENAGA KESEHATAN MASYARAKAT"
