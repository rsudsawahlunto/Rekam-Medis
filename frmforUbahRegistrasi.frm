...
Begin VB.Form frmforUbahRegistrasi 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Ubah Registrasi"
   ClientHeight    =   8985
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8895
   ...
   EndProperty
   Icon            =   "frmforUbahRegistrasi.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame fraPasien 
      ...
      Begin VB.ComboBox cboNamaDepan 
         ...
         EndProperty
         Height          =   390
         ItemData        =   "frmforUbahRegistrasi.frx":0CCA
         Left            =   240
         List            =   "frmforUbahRegistrasi.frx":0CE0
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   600
         Width           =   1335
      ...
      Begin VB.ComboBox cboJnsKelaminPasien 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmforUbahRegistrasi.frx":0D04
         Left            =   240
         List            =   "frmforUbahRegistrasi.frx":0D0E
         Style           =   2  'Dropdown List
         TabIndex        =   10
         Top             =   1320
         Width           =   1335
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboPegawaiToPasien 
         Appearance      =   0  'Flat
         Height          =   330
         ItemData        =   "frmforUbahRegistrasi.frx":0D28
         Left            =   5760
         List            =   "frmforUbahRegistrasi.frx":0D2A
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   480
         Visible         =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7200
      Picture         =   "frmforUbahRegistrasi.frx":0D2C
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmforUbahRegistrasi.frx":1AB4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   13095
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmforUbahRegistrasi.frx":3112
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
End
Attribute VB_Name = "frmforUbahRegistrasi"
...
Private Sub sp_IdentitasPasien(ByVal adoCommand As ADODB.Command)
    ...
    With adoCommand
        ...
        End If
        .Parameters.Append .CreateParameter("OutputNoCM", adChar, adParamOutput, 12, Null)
...
Public Sub subLoadDataPasien(strInput As String)
    ...
    txtNamaPanggilan.Text = rsLoadPasien.Fields("NamaPanggilan").value
    'cboNamaDepan.Text = rsLoadPasien.Fields("Title").value
    Dim i As Integer
    For i = 0 To cboNamaDepan.ListCount
        If (rsLoadPasien.Fields("Title").value = cboNamaDepan.List(i)) Then
            cboNamaDepan.ListIndex = i
        End If
    Next i
