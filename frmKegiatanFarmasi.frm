...
Begin VB.Form frmKegiatanFarmasi 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst 2000 - Kegiatan Farmasi Rumah Sakit"
   ClientHeight    =   2850
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8625
   ...
   EndProperty
   Icon            =   "frmKegiatanFarmasi.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   6840
      Picture         =   "frmKegiatanFarmasi.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmKegiatanFarmasi.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmKegiatanFarmasi.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmKegiatanFarmasi"
...
Private Sub cmdCetak_Click()
    ...
    frm_cetak_KegiatanFarmasiRS.Show
    Exit Sub
errLoad:
    msubPesanError
End Sub
