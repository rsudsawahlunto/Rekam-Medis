...
Begin VB.Form frm_cetak_KesehatanJiwa2 
   Caption         =   "Laporan Cetak Kesehatan Jiwa"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   Icon            =   "frm_cetak_KesehatanJiwa2.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   4680
   ...
   End
End
Attribute VB_Name = "frm_cetak_KesehatanJiwa2"
...
Set frm_cetak_KesehatanJiwa2 = Nothing
End Sub
