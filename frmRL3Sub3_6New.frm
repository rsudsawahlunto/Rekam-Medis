...
Begin VB.Form frmRL3Sub3_6New 
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRL3Sub3_6New.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   4575
   End
End
Attribute VB_Name = "frmRL3Sub3_6New"
...
Private Sub cmdCetak_Click()
    ...
    Set rsx = Nothing
    strSQL = "Select distinct * from RL3_06New where Tglpelayanan between '" & Format(dtpAwal.value, "yyyy/MM/dd 00:00:00") & "' and '" & Format(dtpAkhir.value, "yyyy/MM/dd 23:59:59") & "'or tglpelayanan is null"
    ...
    For i = 1 To rsx.RecordCount
        ...
        Cell2 = oSheet.Cells(j, 7).value
        Cell3 = oSheet.Cells(j, 8).value
        Cell4 = oSheet.Cells(j, 9).value

        If rsx!Spesialisasi = "Bedah" Then
            With oSheet
                .Cells(j, 6) = Trim(rsx![Khusus] + Cell1)
                .Cells(j, 7) = Trim(rsx![Besar] + Cell2)
                .Cells(j, 8) = Trim(rsx![Sedang] + Cell3)
                .Cells(j, 9) = Trim(rsx![Kecil] + Cell4)
            End With
        ElseIf rsx!Spesialisasi = "Obstetrik &Ginekologi" Then
            With oSheet
                .Cells(j, 6) = Trim(rsx![Khusus] + Cell1)
