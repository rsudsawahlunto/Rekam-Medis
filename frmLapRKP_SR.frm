...
Begin VB.Form frmLapRKP_SR 
   ...
   Begin VB.Image Image1 
      Height          =   930
      Left            =   -2715
      Picture         =   "frmLapRKP_SR.frx":08CA
      Top             =   0
      Width           =   10200
   End
End
Attribute VB_Name = "frmLapRKP_SR"
...
'**********************************************
    If optGroupBy(0).Value = True Then
    '**Jika Perhari >>
        If strCetak = "LapRekapKPSR" Then
        strSQL = "SELECT * FROM   V_RekapitulasiKunjunganPasienBstatusdanRujukan " _
        ...
        mstrCetak2 = "LapRekapKPSRhr"
        End If
    '**Jika B Bulan >>
    ElseIf optGroupBy(1).Value = True Then
         If strCetak = "LapRekapKPSR" Then
        strSQL = "SELECT {fn MONTHNAME (TglPendaftaran) } AS TglPendaftaran, RuanganPelayanan, Judul, Detail, JK, JmlPasien, KdInstalasi  FROM   V_RekapitulasiKunjunganPasienBstatusdanRujukan " _
        & "WHERE (TglPendaftaran BETWEEN '" _
        & Format(mdTglAwal, "yyyy/MM/dd 00:00:00") & "' AND '" _
        & Format(mdTglAkhir, "yyyy/MM/dd 23:59:59") & "') and KdInstalasi='" & dcInstalasi.BoundText & "' "
        mstrCetak2 = "LapRekapKPSRbln"
        End If
    End If
'+++++++++++++++++++++++++++++++++++++++++++++++
    msubRecFO rs, strSQL
