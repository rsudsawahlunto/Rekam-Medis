...
Begin VB.Form frmRL2aHAL1 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - RL2a "
   ClientHeight    =   8040
   ClientLeft      =   7725
   ClientTop       =   1755
   ClientWidth     =   6240
   Icon            =   "frmRL2aHAL1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   3360
      Picture         =   "frmRL2aHAL1.frx":4CE9
      Stretch         =   -1  'True
      Top             =   0
      Width           =   2955
   End
End
Attribute VB_Name = "frmRL2aHAL1"
...
Private Sub cmdCetak_Click()
    ...
    If Option5.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.1.xls")
        ...
        oSheet.Cells(4, 12).value = Format(frmRL2aHAL1.dtptahun.value, "yyyy")
        ...
        Set rs = Nothing
        strSQL = " SELECT  a.NoDTD, a.QNoDTD, 'Grup' = case when a.NoDTD < = '298' then '0' else '1' end, a.NamaDTD, a.NoDTerperinci, " _
        & "isnull(sum(b.Kel_Umur1), 0) as Kel_Umur1, isnull(sum(b.Kel_Umur2), 0) as Kel_Umur2,isnull(sum(b.Kel_Umur3), 0) as Kel_Umur3, " _
        & "isnull(sum(b.Kel_Umur4), 0) as Kel_Umur4,isnull(sum(b.Kel_Umur5), 0) as Kel_Umur5,isnull(sum(b.Kel_Umur6), 0) as Kel_Umur6, " _
        & "isnull(sum(b.Kel_Umur7), 0) as Kel_Umur7,isnull(sum(b.Kel_Umur8), 0) as Kel_Umur8, isnull(sum(b.Kel_L), 0) as Kel_L,isnull(sum(b.Kel_P), 0) as Kel_P, " _
        & "isnull(sum(b.Kel_L), 0) + isnull(sum(b.Kel_P), 0) as Kel_H,isnull(sum(b.Kel_M), 0) as Kel_M,isnull(sum(b.Kel_L), 0) + isnull(sum(b.Kel_P), 0) as Total " _
        & "FROM DIAGNOSADTD a left outer join (select a.tglPeriksa, b.NoDTD, sum(a.JmlPasienKel1) as Kel_Umur1,sum(a.JmlPasienKel2) as Kel_Umur2, sum(a.JmlPasienKel3) as Kel_Umur3, " _
        & "sum(a.JmlPasienKel4) as Kel_Umur4, sum(a.JmlPasienKel5) as Kel_Umur5, sum(a.JmlPasienKel6) as Kel_Umur6, sum(a.JmlPasienKel7) as Kel_Umur7,sum(a.JmlPasienKel8) as Kel_Umur8, " _
        & "sum(JmlPasienOutPria) as Kel_L,sum(a.JmlPasienOutWanita) as Kel_P, sum(a.JmlPasienOutHidup) as Kel_H,sum(a.JmlPasienOutMati) as Kel_M, sum(a.JmlKunjungan) as Kel_Kunj, a.KdRuangan, " _
        & "d.KdInstalasi , a.NoPendaftaran " _
        & "from PeriksaDiagnosa a inner join Diagnosa b on a.kdDiagnosa = b.kdDiagnosa " _
        & "inner join registrasiRI c on a.NoPendaftaran = c.NoPendaftaran " _
        & "inner join Ruangan d on a.kdRUangan = d.kdRUangan " _
        & "left outer join PasienBatalDirawat e on a.NoPendaftaran = e.NoPendaftaran " _
        & "WHERE   a.TglPeriksa BETWEEN '" & Format(dtpAwal, "yyyy/MM/dd ") & "' AND '" & Format(dtpAkhir, "yyyy/MM/dd") & "' and e.NoPendaftaran is Null " _
    ...
    ElseIf Option6.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.2.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option7.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.3.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option8.value = True Then
        ...
        oXL.Visible = True
        ' Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.4.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option9.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.5.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option10.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.6.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option11.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.7.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option12.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.8.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option13.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.9.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option14.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.10.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option15.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.11.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option16.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.12.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option17.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.13.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option18.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.14.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option19.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.15.xls")
        Set oSheet = oWB.ActiveSheet
        ...
        If rs.RecordCount > 0 Then
            ...
            " sum(Kel_L)as Kel_L, sum(Kel_P)as Kel_P, sum(Kel_Kunj)as Kel_M, sum(Total)as Total from rl2a where bulan between '" & Format(dtpAwal, "MM ") & "' AND '" & Format(dtpAkhir, "MM") & "'" & _
            ...
            With oSheet
                ...
                .Cells(j, 18) = Trim(IIf(IsNull(rsx!Kel_P.value), 0, (rsx!Kel_L.value)))
                .Cells(j, 19) = Trim(IIf(IsNull(rsx!total.value), 0, (rsx!total.value)))
                .Cells(j, 20) = Trim(IIf(IsNull(rsx!Kel_M.value), 0, (rsx!Kel_M.value)))
            End With
        End If
    ElseIf Option20.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.16.xls")
        Set oSheet = oWB.ActiveSheet
    ...
    ElseIf Option21.value = True Then
        ...
        oXL.Visible = True
        'Buat Buka Template
        Set oWB = oXL.Workbooks.Open(App.Path & "\RL 2A Data Keadaan Morbiditas Rawat Inap Hal.17.xls")
        Set oSheet = oWB.ActiveSheet
        ...
        If rs.RecordCount > 0 Then
            ...
            strSQL = "select sum(Kel_Umur1)as Kel_Umur1, sum(Kel_Umur2)as Kel_Umur2, sum(Kel_Umur3)as Kel_Umur3, sum(Kel_Umur4)as Kel_Umur4, " & _
            " sum(Kel_Umur5)as Kel_Umur5, sum(Kel_Umur6)as Kel_Umur6, sum(Kel_Umur7)as Kel_Umur7, sum(Kel_Umur8)as Kel_Umur8, " & _
            " sum(Kel_L)as Kel_L, sum(Kel_P)as Kel_P, sum(Total)as Total, sum(Kel_M)as Kel_M from rl2a where bulan between '" & Format(dtpAwal, "MM") & "' AND '" & Format(dtpAkhir, "MM") & "'" & _
...
Private Sub setcell()
    While Not rs.EOF
        With oSheet
            ...
            .Cells(j, 20) = Trim(IIf(IsNull(rs!Kel_M.value), 0, (rs!Kel_M.value)))
        End With
        j = j + 1
        rs.MoveNext
    Wend
