...
Begin VB.Form frmTenagaKeterapianFisik 
   Caption         =   "Medifirst2000 - Data Ketenagaan"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8325
   Icon            =   "frmTenagaKeterapianFisik.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6795
   ScaleWidth      =   8325
   ...
   End
End
Attribute VB_Name = "frmTenagaKeterapianFisik"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New crtenagaketerapianfisik
...
Private Sub Form_Load()
    ...
    "jmlhonorer " & _
    "FROM V_Ketenagaan WHERE  (KdkualifikasiJurusan IN ('0031', '0032','0033','0182')) " & _
    ...
    Set frmTenagaKeterapianFisik = Nothing
    ...
    With Report
        ...
        .Text3.SetText "6. TENAGA KETERAPIAN FISIK"
