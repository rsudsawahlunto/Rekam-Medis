...
Dim Report As New crpekerjaan

Private Sub Form_Load()
    Call openConnection
    Set frmpekerjaan = Nothing
    Set dbcmd = New ADODB.Command

    With dbcmd
        .ActiveConnection = dbConn
        .CommandText = "select * from Pekerjaan"
        .CommandType = adCmdText
    End With

    With Report
        .Database.AddADOCommand dbConn, dbcmd
        .usKdJenisJasaPelayanan.SetUnboundFieldSource ("{ado.KdPekerjaan}")
        .usJenisJasaPelayanan.SetUnboundFieldSource ("{ado.Pekerjaan}")
