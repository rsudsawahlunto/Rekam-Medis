...
Begin VB.Form frmTenagakeperawatan 
   Caption         =   "Medifirst2000 - Data Ketenagaan"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8325
   Icon            =   "frmTenagakeperawatan.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6795
   ScaleWidth      =   8325
   ...
   End
End
Attribute VB_Name = "frmTenagakeperawatan"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New crtenagakeperawatan
...
Private Sub Form_Load()
    ...
    "jmlhonorer " & _
    "FROM V_Ketenagaan WHERE  (KdkualifikasiJurusan IN ('0005', '0006','0007','0144','0145','0146','0147','0148','0149','0150','0174','0175','0176','0177','0178'))  " & _
    ...
    Set frmTenagakeperawatan = Nothing
    ...
    With Report
        ...
        .Text3.SetText "2. TENAGA KEPERAWATAN"
