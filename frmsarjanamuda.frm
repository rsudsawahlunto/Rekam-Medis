...
Begin VB.Form frmsarjanamuda 
   Caption         =   "Medifirst2000 - Data Ketenagaan"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8325
   Icon            =   "frmsarjanamuda.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6795
   ScaleWidth      =   8325
   ...
   End
End
Attribute VB_Name = "frmsarjanamuda"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New crsarjanamuda
...
Private Sub Form_Load()
    ...
    "jmlhonorer " & _
    "FROM V_Ketenagaan WHERE  (KdkualifikasiJurusan IN ('0087', '0088','0091','0093','0094','0186','0097','0101','0104','0106','0108','0111')) " & _
    ...
    With Report
        ...
        .Text2.SetText "B.JUMLAH TENAGA NON KESEHATAN MENURUT JENIS"
        .Text3.SetText "4. SARJANA MUDA / D3 AKADEMI"
