...
Begin VB.Form frmLapRL2B 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Laporan RL2B"
   ClientHeight    =   4800
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5925
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   3360
      Picture         =   "frmLapRL2B.frx":4CE9
      Stretch         =   -1  'True
      Top             =   0
      Width           =   2955
   End
End
Attribute VB_Name = "frmLapRL2B"
...
Private Sub cmdCetak_Click()
    On Error GoTo hell
    Set rs = Nothing
    strSQL = "SELECT a.NoDTD, 'Grup' = case when a.NoDTD < = '298' then '0' else '1' end, a.NamaDTD, a.NoDTerperinci, isnull(sum(b.Kel_Umur1), 0) as Kel_Umur1, isnull(sum(b.Kel_Umur2), 0) as Kel_Umur2, " _
